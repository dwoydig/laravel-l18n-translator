    ...
    <div x-show="modalOpen"
        ...
        <div class="relative bg-white rounded-lg shadow-xl w-full max-w-md p-6">
            <div class="flex items-center justify-between mb-5">
                <h2 class="text-base font-semibold text-gray-900">Add New Language</h2>
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        <input
                            type="text"
                            x-model="query"
                            @input="dropdownOpen = true; selected = ''"
                        ...
                        <div x-show="dropdownOpen && filtered.length > 0"
                        ...
                        <div x-show="dropdownOpen && query.trim() && filtered.length === 0"
